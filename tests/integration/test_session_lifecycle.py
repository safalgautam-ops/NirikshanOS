"""Integration tests: the server-side session mechanism end to end
(app/core/security/sessions.py - report §5.2), exercising the real test
...
def test_deleting_the_session_row_immediately_revokes_it(run_async, make_user):
    """Report §5.2's core comparison against JWTs: revocation is 'delete the
    row', effective on the very next lookup - proven here directly, not
